...
PLUGIN_DESCRIPTION='Plugin de terminal'
PLUGIN_CONFIGURABLE=True
PLUGIN_IMAGE_PATH='plugins/term/pixmaps/'
PLUGIN_ICON=PLUGIN_IMAGE_PATH + 'terminal.png'
PLUGIN_GLADE_FILE='plugins/term/term.glade'
...
class PluginLoader:
	...
	def pageChanged(self,args):
		...
		"""
		filename=self.gui.editor.files[args['fileid']].filename
		if filename!=None:
			dirname=''
			path=filename.split('/')
